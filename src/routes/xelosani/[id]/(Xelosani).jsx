...
import { Show, createEffect, Switch, Match, onCleanup, createSignal } from "solid-js"
    ...
    return (
        ...
        <div class="relative">
            <div class="w-[90%] mx-auto relative mt-8">
                <Show when={user()}>
                    <Show when={modal()}>
                        <div id="modal" class="bg-white shadow-2xl z-[50] top-1/2 transform -translate-y-1/2 -translate-x-1/2 left-1/2  border fixed p-4">
                            <Switch>
                                <Match when={modal() === "ლოკაცია"}>
                                    <ModifyLocaitonModal setModal={setModal} location={user().location}></ModifyLocaitonModal>
                                </Match>
                    ...
                    <div class={`${modal() && "blur-[0.8px] pointer-events-none"} flex items-start`}>

...
import { check_contact, handle_contact } from "~/routes/api/damkveti/setup";
...
const Contact = () => {
    ...
    return <Switch>
        ...
        <Match when={contact() === "fine" || submitted()}>
            ...
            <A className="py-2 mt-3 text-center w-1/2 rounded-md text-sm font-[thin-font] font-bold bg-dark-green text-white transition-all duration-500 hover:bg-dark-green-hover" href="/setup/damkveti/step/about">გაგრძელება</A>
            </div>
        </Match>
    </Switch>
}

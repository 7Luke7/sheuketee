...
const Skills = (props) => {
  ...
  return (
    <div class="flex flex-col justify-between w-full items-center h-full mb-4">
      <Switch>
        <Match when={!check_jobs()?.length}>
      ...
      <div class="h-full w-full relative">
        ...
        <div class="flex items-center flex-col justify-center h-full">
              <p class="text-sm font-[normal-font] font-bold text-gray-700">თქვენ უნარები დამატებული გაქვთ გთხოვთ განაგრძოთ.</p>
              <A className="py-2 mt-3 text-center w-1/2 rounded-md text-sm font-[thin-font] font-bold bg-dark-green text-white transition-all duration-500 hover:bg-dark-green-hover" href="/setup/xelosani/step/location">გაგრძელება</A>
            </div>
        </Match>
      </Switch>
    </div>

...
export const Search = ({value, setValue, chosenQuery, setDisplayOption}) => {
    return <form class="border font-[thin-font] rounded-[16px] px-3 py-1 border-[#6e6967] flex items-center">
        ...
        <button type="button" id="search_query_options_button" onClick={() => setDisplayOption((prev) => !prev)} class="border-l flex items-center px-2 border-[#6e6967]">

    ...
    return <>
        ...
        <div class="flex itmes-center py-3 m-auto w-[90%]">
            ...
            <div class="flex w-full justify-between items-center font-[normal-font]">
                ...
                {/* აქ შეიძლება ხელოსნების სია გაეშვას რისთვისაც თანხის გადახდა დაჭირდებათ */}
                <div class="px-3 font-[thin-font] text-sm items-center font-bold flex gap-x-3">
                    ...
                    <A href="/register" class="bg-dark-green hover:bg-dark-green-hover transition ease-in delay-20 text-white px-3 py-1 rounded-[16px]">რეგისტრაცია</A>
                </div>
            </div>
        </div>
        {displayOptions() && <div id="options-menu" class="absolute right-[13%] z-50 bg-white opacity-100 w-[230px]">
                ...
                <button class="text-left w-full" onClick={() => switch_query_options("ხელოსანი")}>
                    <li class="flex p-2 hover:bg-[rgb(243,244,246)] rounded-[16px] gap-x-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-gray font-bold text-xs font-[thin-font]">მოძებნე პროფესიონალი ხელოსნები</p>
                        </div>
                    </li>
                </button>
                <button class="text-left w-full" onClick={() => switch_query_options("სამუშაო")}>
                    <li class="flex p-2 hover:bg-[rgb(243,244,246)] rounded-[16px] mt-2 gap-x-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-gray font-bold text-xs font-[thin-font]">მოძებნე სამუშაო</p>
                        </div>
                    </li>
                </button>
            </ul>

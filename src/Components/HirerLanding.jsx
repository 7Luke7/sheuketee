            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-col items-start gap-y-2">
                    ...
                    <div class="flex gap-x-2 mt-3 items-center">
                        <A href="/choose" class="font-[thin-font] font-bold bg-dark-green hover:bg-dark-green-hover transition ease-in delay-20 text-white px-8 py-2 rounded-[16px]">გახდი დამკვეთი</A>
                        <A href="/hire" class="font-[thin-font] font-bold border border-dark-green transition ease-in delay-20 px-8 py-2 rounded-[16px]">გაიგე მეტი</A>
                    </div>              
              </div>
            </div>
